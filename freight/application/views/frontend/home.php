        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('<?= base_url();?>assets/img/sea-frieght.jpg')"></div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('<?= base_url();?>assets/img/Air-Freight.jpg')"></div>
                    <div class="service-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('<?= base_url();?>assets/img/Road-Freight.jpg')"></div>
                    <div class="service-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('<?= base_url();?>assets/img/Warehousing.jpg')"></div>
                    <div class="service-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('<?= base_url();?>assets/img/Customs-Clearance.jpg')"></div>
                    <div class="service-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('<?= base_url();?>assets/img/Multimodal-Transport.jpg')"></div>
                    <div class="service-icon">
